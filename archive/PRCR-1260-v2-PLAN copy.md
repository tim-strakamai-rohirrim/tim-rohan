...
- [ ] **1.1** Add `converted_html_key VARCHAR(500) NULL` column to `compliance_documents` table.
  - File: `Database/rohan_api/scripts/sql/init_compliance.sql`
- [ ] **1.2** Add `convertedHtmlKey` column to `ComplianceDocument` TypeORM entity.
  - File: `rohan_api-parent/feature/src/compliance/entities/compliance-document.entity.ts`
- [ ] **1.3** In `ComplianceListener.handleAutoTagComplete`, save `event.convertedHtmlUrl` to the document's `convertedHtmlKey`.
  ...
  - File: `rohan_api-parent/feature/src/compliance/listeners/compliance.listener.ts`
...
- [ ] **1.5** Unit tests: verify `handleAutoTagComplete` persists the key, and verify deleted-document guard skips gracefully.
  - File: `rohan_api-parent/feature/src/compliance/compliance.listener.spec.ts`
...
- [ ] **2.1** Add `getDocumentContent(projectId, documentId)` method to `ComplianceService`.
  ...
  - File: `rohan_api-parent/feature/src/compliance/compliance.service.ts`
- [ ] **2.2** Add `GET /compliance/projects/:projectId/documents/:documentId/content` to controller.
  ...
  - File: `rohan_api-parent/feature/src/compliance/compliance.controller.ts`
- [ ] **2.3** Create response DTO `DocumentContentResponseDto`.
  - File: `rohan_api-parent/feature/src/compliance/dto/document-content-response.dto.ts`
- [ ] **2.4** Unit test for service method (mock MinIO download).
  - File: `rohan_api-parent/feature/src/compliance/compliance.service.spec.ts`
- [ ] **2.5** Controller spec for the new route.
  - File: `rohan_api-parent/feature/src/compliance/compliance.controller.spec.ts`
...
- [ ] **5.1** Add `getDocumentContent(projectId, documentId): Observable<DocumentContentResponse>` to `ComplianceApiService`.
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/services/compliance-api.service.ts`
...
- [ ] **5.4** Add `DocumentContentResponse` interface (or inline).
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/types/compliance-project.types.ts`
...
- [ ] **5.6** Unit tests for new service methods.
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/services/compliance-api.service.spec.ts`
...
- [ ] **6.1** Update `ComplianceStateService` to load HTML content per document.
  ...
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/services/compliance-state.service.ts`
- [ ] **6.2** Replace `document.lines` rendering in the viewer template with `app-doc-shell`.
  ...
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/document-viewer-panel/document-viewer-panel.component.html`
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/document-viewer-panel/document-viewer-panel.component.ts`
...
- [ ] **6.5** Configure `TaggingService` with a compliance-specific tag config for the `COMPLIANCE` product code.
  ...
  - File: `rohan_ui-parent/feature/src/app/shared-services/tagging/tagging.service.ts` (if extending)
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/document-viewer-panel/document-viewer-panel.component.ts`
...
- [ ] **6.7** Update `ComplianceSourceDocument` type — remove `lines`, `pageNumber`, `totalPages`; add `processingStatus`.
  ...
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/types/compliance-item.types.ts`
- [ ] **6.8** Rewrite `mapProjectDocumentsToViewerDocuments()` to build `ComplianceSourceDocument` from project documents **without** mock data.
  ...
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/utils/compliance-document.utils.ts`
- [ ] **6.9** Update `compliance-document.utils.spec.ts` tests.
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/utils/compliance-document.utils.spec.ts`
- [ ] **6.10** Remove or retire `app-pdf-highlight-overlay` component (no longer needed — `doc-shell` handles highlighting).
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/pdf-highlight-overlay/` (all files)
- [ ] **6.11** Verify `SharedComponentsModule` is already imported in `ComplianceModule` (it is — `app-doc-shell` is already available, no changes needed).
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/compliance.module.ts`
...
- [ ] **7.3** Update the compliance items panel ↔ viewer interaction.
  ...
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/compliance-list-creator/compliance-list-creator.component.ts`
- [ ] **7.4** Component tests for the updated viewer panel.
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/document-viewer-panel/document-viewer-panel.component.spec.ts`
...
- [ ] **8.1** Add `app-document-upload` component to the Document Library section of the overview page.
  ...
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/project-snapshot-content/project-snapshot-content.component.html`
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/project-snapshot-content/project-snapshot-content.component.ts`
- [ ] **8.2** Update `compliance-document-table` to include a delete button per row.
  - Emit a `deleteDocument` event with the document ID.
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/compliance-document-table/compliance-document-table.component.html`
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/compliance-document-table/compliance-document-table.component.ts`
- [ ] **8.3** Wire delete button through to `ComplianceApiService.deleteSourceDocument()`.
  ...
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/compliance-project-overview-page/compliance-project-overview-page.component.ts`
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/project-overview-tab/project-overview-tab.component.ts`
...
- [ ] **8.5** Component tests for upload and delete flows.
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/project-snapshot-content/project-snapshot-content.component.spec.ts`
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/components/compliance-document-table/compliance-document-table.component.spec.ts`
...
- [ ] **9.1** Delete `MOCK_COMPLIANCE_DOCUMENTS`, `PRIMARY_DOCUMENT_LINES`, `SECONDARY_DOCUMENT_LINES`, `TERTIARY_DOCUMENT_LINES` from mock data file. Keep `ITEM_SEEDS` if still needed by tests.
  - File: `rohan_ui-parent/feature/src/app/pages/compliance/mocks/compliance-item-mock-data.ts`
...
- [ ] **10.1** Backend E2E: upload a document, trigger process, wait for auto-tag completion, GET content, verify HTML returned.
  - File: `rohan_api-parent/feature/test/compliance.e2e-spec.ts`
...
| Phase | Key files |
|-------|-----------|
| **1** | `init_compliance.sql`, `compliance-document.entity.ts`, `compliance.listener.ts`, `compliance.listener.spec.ts` |
| **2** | `compliance.controller.ts`, `compliance.service.ts`, `document-content-response.dto.ts` (new) |
| **3** | `compliance.controller.ts`, `compliance.service.ts` |
| **4** | `compliance.controller.ts`, `compliance.service.ts` |
| **5** | `compliance-api.service.ts`, `compliance-project.types.ts` |
| **6** | `document-viewer-panel.component.*`, `compliance-state.service.ts`, `compliance-document.utils.ts`, `compliance-item.types.ts`, `tagging.service.ts` (config), `pdf-highlight-overlay/` |
| **7** | `document-viewer-panel.component.*`, `compliance-list-creator.component.ts` |
| **8** | `project-snapshot-content.component.*`, `compliance-document-table.component.*`, `compliance-project-overview-page.component.ts` |
| **9** | `compliance-item-mock-data.ts`, `compliance-document.utils.ts` |
| **10** | `compliance.e2e-spec.ts`, Playwright tests |
